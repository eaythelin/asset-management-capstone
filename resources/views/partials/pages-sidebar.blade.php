<div class="drawer-side lg:fixed lg:top-0 lg:left-0 lg:h-screen lg:z-0">
  ...
  <ul class="menu p-4 w-80 min-h-full text-base-content bg-blue-800">
    ...
    <div class="flex items-center p-4 border-b border-blue-700">
      ...
      <span class="ml-3 font-bold text-white text-lg md:text-xl">Master Coating Industrial Technology Incorporated</span>
    </div>
